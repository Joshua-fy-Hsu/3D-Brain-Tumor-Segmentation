...
# Widened 2026-05-19: the old ET grid floored at 500 but unet3d's optimum
# already sat at that 500 floor, so the true optimum was very likely below
# it and unsearchable. Now spans 0..2000 (incl. sub-500) + finer TC + a
# wider TAU. The fixed-default operating point (ET_VMIN_DEFAULT=1000,
